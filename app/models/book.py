...
class Book(Base):
    ...
    # Relationships
    pages = relationship("Page", back_populates="book", foreign_keys="Page.book_id", cascade="all, delete-orphan")
    home_page = relationship("Page", foreign_keys="Book.home_page_id", post_update=True)
