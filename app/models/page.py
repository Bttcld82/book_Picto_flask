...
class Page(Base):
    ...
    # Relationships
    book = relationship("Book", back_populates="pages", foreign_keys="Page.book_id")
    cards = relationship("Card", back_populates="page", foreign_keys="Card.page_id", cascade="all, delete-orphan")
